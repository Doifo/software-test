  ...
  <el-container>
    ...
    <el-main style="padding: 0">
      <el-container>
        ...
        <el-main
          style="padding: 0; background-color: #efefef; padding-bottom: 30px; padding-top: 30px"
        >
          <div
          ...
          <div style="width: 25%; margin-left: 40px; float:left;">
            ...
            >
              ...
              <el-row style="margin-top: 15px">
                ...
                <el-col :span="12" style="text-align: right">{{userInfo.withdrawnMethod}}</el-col>
              </el-row>
            ...
            >
              <el-row style="font-size: 16pt; margin-top: 10px">
                ...
                <el-col :span="12" style="text-align: right">
                  <el-button type="primary" style="font-size: 12pt" @click="getMoney" size="mini">确定</el-button>
                </el-col>
              </el-row>
            </div>
          </div>
          ...
          this.$confirm("确认提现吗？", "提现", {
            ...
            .then(() => {
              ...
              if (value > this.userInfo.balance) {
                ...
                param.append("workerId", this.userInfo.id);
                param.append("value", value);
                param.append("type", this.userInfo.withdrawnMethod);
                axios
