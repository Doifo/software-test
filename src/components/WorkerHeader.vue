      ...
      <el-col class="user-button">
        <el-dropdown trigger="click">
          ...
          <el-dropdown-menu slot="dropdown">
            <span v-show="worker">
              <router-link to="/worker-information" style="text-decoration:none;">
                <el-dropdown-item>个人中心</el-dropdown-item>
              </router-link>
            </span>
            <span v-show="requester">
              <router-link to="/requester-information" style="text-decoration:none;">
                <el-dropdown-item>个人中心</el-dropdown-item>
              </router-link>
            </span>
    ...
    <el-row class="worker-nav">
      <el-col :span="7" :offset="2">
        <span v-show="worker">
          ...
          <router-link to="/worker-statistic">
            <button class="nav-button">统计</button>
          </router-link>
          <router-link to="/worker-qualification">
            <button class="nav-button">资格</button>
          </router-link>
        </span>
        <span v-show="requester">
