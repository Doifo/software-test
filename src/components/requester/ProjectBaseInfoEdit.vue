    ...
    <el-form 
      ...
      >
        ...
        <el-input-number v-model="reward" :precision="2"  type="number"
                            :step="0.1" :min="0" style="min-width:80px;!important width:20%;margin-right:10px"></el-input-number>元
        <el-popover
        ...
        <el-input-number v-model="time_limitation" :precision="2" :min="0" type="number"
                            style="min-width:80px;!important width:20%;margin-right:10px"></el-input-number>小时
        <el-popover
            placement="right-start"
            title="属性说明"
            width="200"
        ...
        <el-input-number v-model="pay_time" :precision="2" type="number"
                            style="min-width:80px;!important width:20%;margin-right:10px" :max="72" :min="0"></el-input-number>小时
        <el-popover
            placement="right-start"
            title="属性说明"
            width="200"
        ...
        <el-form-item label="等级要求">
            <el-input-number v-model="level" type="number"
                            :min="0" style="min-width:80px;!important width:20%;margin-right:10px"></el-input-number>
            <el-popover
            placement="right-start"
            title="属性说明"
            width="200"
        ...
        <el-form-item label="年龄要求">
            <el-input-number v-model="min_age" type="number"
                            :min="0" style="min-width:30px;!important width:20%;margin-right:10px"></el-input-number>
            <span style="margin-right:10px;"> 至 </span>
            <el-input-number v-model="max_age"
                            :min="0" style="min-width:80px;!important width:20%;margin-right:10px"></el-input-number>
        </el-form-item>
      </el-form>
